...
def test_lightning():
    ...
    result = light.lightning(m, obj, lght, position, eyev, normalv)
...
def test_lightning6():
    ...
    in_shadow = True
    result = light.lightning(m, obj, lght, position, eyev, normalv, in_shadow)
...
def test_lightning7():
    """Light with a pattern supplied"""
    m = material.material()
    m.pattern = patterns.stripe_pattern(
            color.color(1, 1, 1),
            color.color(0, 0, 0)
            )
    m.ambient = 1
    ...
    c1 = light.lightning(m, obj, lght, base.point(0.9, 0, 0), eyev, normalv)
    c2 = light.lightning(m, obj, lght, base.point(1.1, 0, 0), eyev, normalv)
