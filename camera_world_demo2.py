...
def make_walls():
    ...
    left_wall.transform = transform.compose(
...
def main():
    ...
    canv = camera.render(cam, wrld, True)
    print("[*] Generating the ppm data ...")
    ppm_data = ppm.canvas_to_ppm(canv)
    write_to_file(ppm_data, "camera_world3.ppm")
    print("[+] Done")
